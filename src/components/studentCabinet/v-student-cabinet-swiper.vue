            ...
            <div class="lesson-swiper__info">
              ...
              <div class="lesson-swiper__info-row">
                ...
                <div class="lesson-swiper__block col" v-if="lesson.homeworks && lesson.homeworks.length">
                  ...
                  <p class="lesson-swiper__subtitle" :class="getDeadlineClass(lesson.homeworks[0].due_date)">Дедлайн {{ formatDate(lesson.homeworks[0].due_date) }}</p>
              ...
              <div class="lesson-swiper__info-row" v-if="getStudentSubmissions(lesson)">
                <h4 class="lesson-swiper__title">Оценка</h4>
                  <div class="lesson-swiper__block lesson-swiper__answer">
                    <div class="status" :class="{green:  getStudentSubmissions(lesson).grade >= 4, red:  getStudentSubmissions(lesson).grade < 4}">
...
watch(currentHomework, (newHomework) => {
  const currentLesson = lessons.value[currentLessonIndex.value];
...
function getStudentState(studentId) {
  return studentStatesCache.get(studentId) || {
    currentPage: 1,
...
function getStudentFilesAnswer(lesson) {
  if (lesson.homeworks && lesson.homeworks[0]) {
    ...
    if (props.answer && props.answer.length > 0 && props.currentHomeworkId && homework.id == props.currentHomeworkId) {
